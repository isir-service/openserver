...
private int looks_ascii(const unsigned char *buf, size_t nbytes, file_unichar_t *ubuf, size_t *ulen) 
{
	size_t i; 
...
private int looks_latin1(const unsigned char *buf, size_t nbytes, file_unichar_t *ubuf, size_t *ulen) 
{
	size_t i; 
...
private int looks_extended(const unsigned char *buf, size_t nbytes, file_unichar_t *ubuf, size_t *ulen) 
{
	size_t i; 
